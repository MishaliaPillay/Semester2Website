...
<figcaption>What is says in the image:  The sections with long pages and content such as the design page and the homepage have a back to the top button .The nav bar is accessible in every page so the user can easily switch between them .As a user scrolls ,the content loads and fades in . This makes for interesting response .Sections of information are separated by this fade in and these individual sections are separate paragraphs . This moulds to the amount of text present thus no use of unnecessary spacing </figcaption>
  ...
  },
  {
   ...
   `,
    ...
    <figure>
    <img
      src="./Images/Websafe.png"
      alt="Webssafe fontsimage"
      id="imgg"
    />
    <figcaption>This shows the List of Web Safe fonts.</figcaption>
    </figure>
    ...
    <figure>
     <img
       src="./Images/colorcontrast.png"
       alt="color contrastimage"
       id="imgg"
     />
     <figcaption>This shows the how colour creates focal points.</figcaption>
     </figure>
        <p>There is still a visual hierarchy of the different font-weight along with font sizes, I have however added another aspect of the visual hierarchy by changing the font of some headings in the design section. The use of this font is styled differently which draws the attention of the user directing the user's eyes through the content.</p> <p>I have also created a visual hierarchy through the light blue colour of the headings in the nav as well as the side nav bar. This creates consistency and helps the user familiarise themselves with the website.</p>
        </p>
    
   `,
    paraTwo: `id="RStyleGuide"`,
